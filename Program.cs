...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("7. Geri gelme");
    ...
    static void ProjedenCik()
{
    ...
    class AdminKullanici : Kullanici    //kalıtım // polimorfizm
    {
   ...
   public class Gonullu : IKullanici  //kalıtım //polimorfizm
    {
